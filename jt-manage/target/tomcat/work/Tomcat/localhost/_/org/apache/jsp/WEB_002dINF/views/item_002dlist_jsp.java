 ...
 * Generated at: 2019-01-26 12:39:55 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <th data-options=\"field:'title',width:450\">商品标题</th>\r\n");
      out.write("            <th data-options=\"field:'cid',width:100,align:'center',formatter:KindEditorUtil.findItemName\">叶子类目</th>\r\n");
      out.write("            <th data-options=\"field:'sellPoint',width:450\">卖点</th>\r\n");
      out.write("            <th data-options=\"field:'price',width:90,align:'right',formatter:KindEditorUtil.formatPrice\">价格</th>\r\n");
      out.write("            <th data-options=\"field:'num',width:90,align:'right'\">库存数量</th>\r\n");
      out.write("            <th data-options=\"field:'barcode',width:50\">条形码</th>\r\n");
      out.write("            <th data-options=\"field:'status',width:80,align:'center',formatter:KindEditorUtil.formatItemStatus\">状态</th>\r\n");
      ...
      out.write("            \t\t\t\t$.messager.alert('提示','没有权限操作已删除商品!',undefined,function(){\r\n");
      out.write("            \t\t\t\t});\r\n");
      out.write("            \t\t\t}else{\r\n");
      ...
      out.write("            \t\t\t\t$.messager.alert('提示','请勿重复选择已下架!',undefined,function(){\r\n");
      out.write("            \t\t\t\t});\r\n");
      out.write("            \t\t\t}else if(data.status == 400) {\r\n");
      out.write("            \t\t\t\t$.messager.alert('提示','没有权限操作已删除商品!',undefined,function(){\r\n");
      out.write("            \t\t\t\t\t$(\"#itemList\").datagrid(\"reload\");\r\n");
      ...
      out.write("            \t\t\t\t});\r\n");
      out.write("            \t\t\t}else if(data.status == 201){\r\n");
      out.write("            \t\t\t\t$.messager.alert('提示','请勿重复选择已上架商品!',undefined,function(){\r\n");
      out.write("            \t\t\t\t});\r\n");
      out.write("            \t\t\t}else if(data.status == 400) {\r\n");
      out.write("            \t\t\t\t$.messager.alert('提示','没有权限操作已删除商品!',undefined,function(){\r\n");
      out.write("            \t\t\t\t\t$(\"#itemList\").datagrid(\"reload\");\r\n");
      ...
      out.write("    \t}\r\n");
      out.write("    },'-',{\r\n");
      out.write("    \ttext: ' 商品：<input placeholder=\"输入商品\"  type=\"text\" id=\"ZZtitle\"/> ',\r\n");
      out.write("    },{\r\n");
      out.write("    \ttext: '查询',\r\n");
      out.write("    \ticonCls: 'icon-search',\r\n");
      out.write("    \thandler: function () {\r\n");
      out.write("    \tvar title = $(\"#ZZtitle\").val();\r\n");
      out.write("    \tif(title.length == 0){\r\n");
      out.write("    \t\t$.messager.alert('提示','请输入商品!');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      out.write("    \tvar params= {\"title\":title};\r\n");
      out.write("    \t$.post(\"/item/check\",params, function(data){\r\n");
      out.write("    \t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t\t$(\"#itemList\").datagrid(\"reload\");\r\n");
      out.write("    \t\t\t}else if(data.status == 400) {\r\n");
      out.write("    \t\t\t\t$.messager.alert('提示','未找到有关商品!',undefined,function(){\r\n");
      out.write("    \t\t\t\t\t$(\"#itemList\").datagrid(\"reload\");\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("    \t\t\t}\r\n");
      out.write("    \t\t});\r\n");
