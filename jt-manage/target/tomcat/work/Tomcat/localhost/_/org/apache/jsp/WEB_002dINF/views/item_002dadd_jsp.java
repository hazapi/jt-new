 ...
 * Generated at: 2019-01-26 03:49:44 UTC
...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\r\n");
      out.write("\t\t//alert($(\"#itemAddForm\").serialize());  如果参数有很多,可以进行表单序列化提交\r\n");
      out.write("\t\t/*用户进行数据提交  $.post(url,{key:value,.....},回调函数)*/\r\n");
      out.write("\t\t$.post(\"/item/save\",$(\"#itemAddForm\").serialize(), function(data){\r\n");
      out.write("\t\t\t/*返回值需要进行判断,采用统一的格式进行数据返回 vo  */\r\n");
